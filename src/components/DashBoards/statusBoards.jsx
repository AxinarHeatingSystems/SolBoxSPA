...
export const StatusBoards = () => {
  ...
  return (
    <>
      <Box display={'grid'} gridTemplateColumns="repeat(12, 1fr)" gap="20px" marginY={2}>
        <Box gridColumn="span 12"
          ...
          <Box textAlign={'center'}>
            ...
            {/* <Card sx={{ height: 'fit-content', width: 'fit-content', paddingY: 5, paddingX: 4, backgroundColor: 'transparent' }}>
              <CardMedia
                sx={{ height: 150, width: 150, padding: 3, backgroundRepeat: 'no-repeat', backgroundPosition: 'center' }}
                image={heatEnery}></CardMedia>
            </Card> */}
          </Box>
	...
	c-2-0.1-20-0.8-32.2-1.9c0,0-3.1-0.3-8.1-0.7V300H300z" />
          ...
          <Box textAlign={'center'}>
            ...
            {/* <Card sx={{ height: 'fit-content', width: 'fit-content', padding: 4, backgroundColor: 'transparent' }}>
              <CardMedia
                sx={{ height: 170, width: 150, padding: 3, backgroundRepeat: 'no-repeat', backgroundPosition: 'center' }}
                image={solarEnergy}
                title="green iguana"
              ></CardMedia> 
          </Card>*/}
