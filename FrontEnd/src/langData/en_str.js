export const En_Str = {
    ...
    register_was_successful: 'Registration was successful',
    ...
    other: "Other",
    solopanel_max_power: "Solar Panel Max Power",
    ...
    the_owner: "The owner",
    the_installation_technician: "The installation's technician",
    gps_location: "GPS location",
    cancel: "Cancel",
    save: 'Save',
    save_all: "Save All",
    max_water_temperature: "Max Water Temperature",
    price_per: "Price per",
    vacation_period_start: "Vacation period start",
    vacation_period_end: "Vacation period end",
    device_info: "Device Information",
    searching_your_device: "Searching for your device, please wait...",
    search_your_device: "Search Your Device",
    search: "Search",
    feel_devid_paircode: "Please input your device Id or pairing code",
    please_feel_input: "Please fill the input",
    ...
    pairing: "Pairing",
    not_device_matched_ip:"No Device matched with your IP",
